#
# gigglekat Audio Files
#

ALARM_PATH := vendor/gigglekat/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/gigglekat/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/gigglekat/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/gigglekat/prebuilt/common/media/audio/ui
